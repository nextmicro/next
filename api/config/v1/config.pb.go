...
var file_config_v1_config_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x97, 0x04, 0x0a, 0x04, 0x4e, 0x65, 0x78, 0x74, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x12, 0x2e, 0x0a, 0x06, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x16, 0x2e, 0x6e, 0x65, 0x78, 0x74, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65,
	0x77, 0x61, 0x72, 0x65, 0x52, 0x0b, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65,
	0x73, 0x22, 0x9b, 0x01, 0x0a, 0x0a, 0x48, 0x54, 0x54, 0x50, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	...
	0x74, 0x12, 0x3c, 0x0a, 0x0b, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x73,
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6e, 0x65, 0x78, 0x74, 0x2e, 0x63, 0x6f,
	...
	0x9b, 0x01, 0x0a, 0x0a, 0x47, 0x52, 0x50, 0x43, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x1a,
	...
	0x52, 0x07, 0x61, 0x75, 0x74, 0x6f, 0x41, 0x63, 0x6b, 0x22, 0x69, 0x0a, 0x08, 0x52, 0x65, 0x67,
	0x69, 0x73, 0x74, 0x72, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x64, 0x64,
	0x72, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x64, 0x64, 0x72, 0x73, 0x12,
	...
	0x65, 0x6f, 0x75, 0x74, 0x22, 0x59, 0x0a, 0x07, 0x54, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x12,
	0x18, 0x0a, 0x07, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x07, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x64,
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x65, 0x6e, 0x64,
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x72,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x07, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x72, 0x22,
...
var file_config_v1_config_proto_depIdxs = []int32{
	...
	2,  // 3: next.config.v1.Next.client:type_name -> next.config.v1.Client
	7,  // 4: next.config.v1.Next.logger:type_name -> next.config.v1.Logger
	12, // 5: next.config.v1.Next.tracing:type_name -> next.config.v1.Tracing
	13, // 6: next.config.v1.Next.nacos:type_name -> next.config.v1.Nacos
	8,  // 7: next.config.v1.Next.broker:type_name -> next.config.v1.Broker
	4,  // 8: next.config.v1.Server.http:type_name -> next.config.v1.HTTPServer
	3,  // 9: next.config.v1.Server.grpc:type_name -> next.config.v1.GRPCServer
	5,  // 10: next.config.v1.Client.http:type_name -> next.config.v1.HTTPClient
	6,  // 11: next.config.v1.Client.grpc:type_name -> next.config.v1.GRPCClient
	17, // 12: next.config.v1.GRPCServer.timeout:type_name -> google.protobuf.Duration
	14, // 13: next.config.v1.GRPCServer.middlewares:type_name -> next.config.v1.Middleware
	17, // 14: next.config.v1.HTTPServer.timeout:type_name -> google.protobuf.Duration
	14, // 15: next.config.v1.HTTPServer.middlewares:type_name -> next.config.v1.Middleware
	17, // 16: next.config.v1.HTTPClient.timeout:type_name -> google.protobuf.Duration
	14, // 17: next.config.v1.HTTPClient.middlewares:type_name -> next.config.v1.Middleware
	17, // 18: next.config.v1.GRPCClient.timeout:type_name -> google.protobuf.Duration
	14, // 19: next.config.v1.GRPCClient.middlewares:type_name -> next.config.v1.Middleware
	16, // 20: next.config.v1.Logger.metadata:type_name -> next.config.v1.Logger.MetadataEntry
	9,  // 21: next.config.v1.Broker.publish:type_name -> next.config.v1.Publish
	10, // 22: next.config.v1.Broker.subscribe:type_name -> next.config.v1.Subscribe
	17, // 23: next.config.v1.Registry.timeout:type_name -> google.protobuf.Duration
	17, // 24: next.config.v1.Nacos.timeout:type_name -> google.protobuf.Duration
	18, // 25: next.config.v1.Middleware.options:type_name -> google.protobuf.Any
