...
const (
	Exporter_UNKNOWN_EXPORTER  Exporter = 0 // unknown exporter
	Exporter_OTLPHTTP_EXPORTER Exporter = 1 // otlphttp exporter
	Exporter_OTLPGPRC_EXPORTER Exporter = 2 // otlpgrpc exporter
	Exporter_STDOUT_EXPORTER   Exporter = 3 // stdout exporter
	Exporter_ZIPKIN_EXPORTER   Exporter = 4 // zipkin exporter
	Exporter_FILE_EXPORTER     Exporter = 5 // file exporter
)

// Enum value maps for Exporter.
var (
	Exporter_name = map[int32]string{
		0: "UNKNOWN_EXPORTER",
		1: "OTLPHTTP_EXPORTER",
		2: "OTLPGPRC_EXPORTER",
		3: "STDOUT_EXPORTER",
	...
	Exporter_value = map[string]int32{
		"UNKNOWN_EXPORTER":  0,
		"OTLPHTTP_EXPORTER": 1,
		"OTLPGPRC_EXPORTER": 2,
		"STDOUT_EXPORTER":   3,
...
func (Exporter) Descriptor() protoreflect.EnumDescriptor {
	return file_config_v1_config_proto_enumTypes[0].Descriptor()
}

func (Exporter) Type() protoreflect.EnumType {
	return &file_config_v1_config_proto_enumTypes[0]
}

func (x Exporter) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Exporter.Descriptor instead.
func (Exporter) EnumDescriptor() ([]byte, []int) {
...
type Broker struct {
	...
	Name      string     `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`           // broker名
	Addrs     []string   `protobuf:"bytes,2,rep,name=addrs,proto3" json:"addrs,omitempty"`         // broker地址
	Publish   *Publish   `protobuf:"bytes,3,opt,name=publish,proto3" json:"publish,omitempty"`     // broker发布配置
	Subscribe *Subscribe `protobuf:"bytes,4,opt,name=subscribe,proto3" json:"subscribe,omitempty"` // broker订阅配置
}
...
type Registry struct {
	...
	Name    string               `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`       // 注册中心类型: etcd，consul
	Addrs   string               `protobuf:"bytes,2,opt,name=addrs,proto3" json:"addrs,omitempty"`     // 注册中心地址，多个用逗号隔开
	Timeout *durationpb.Duration `protobuf:"bytes,3,opt,name=timeout,proto3" json:"timeout,omitempty"` // 注册中心超时时间
}
...
type Telemetry struct {
	...
	Exporter     Exporter          `protobuf:"varint,4,opt,name=exporter,proto3,enum=next.config.v1.Exporter" json:"exporter,omitempty"`
	OTLPHeaders  map[string]string `protobuf:"bytes,5,rep,name=OTLPHeaders,proto3" json:"OTLPHeaders,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // otlp headers
	OPLPHttpPath string            `protobuf:"bytes,6,opt,name=OPLPHttpPath,proto3" json:"OPLPHttpPath,omitempty"`                                                                                       // otlp http path
}
...
func (x *Telemetry) GetExporter() Exporter {
	if x != nil {
		return x.Exporter
	}
	return Exporter_UNKNOWN_EXPORTER
}

func (x *Telemetry) GetOTLPHeaders() map[string]string {
	if x != nil {
...
func (x *Telemetry) GetOPLPHttpPath() string {
	if x != nil {
		return x.OPLPHttpPath
	}
	return ""
}
...
var file_config_v1_config_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x9e, 0x01, 0x0a, 0x06,
	0x42, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	...
	,
	...
	,
	...
	0x64, 0x12, 0x17, 0x0a, 0x07, 0x6c, 0x6f, 0x67, 0x5f, 0x64, 0x69, 0x72, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x6c, 0x6f, 0x67, 0x44, 0x69, 0x72, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x61,
	0x63, 0x68, 0x65, 0x5f, 0x64, 0x69, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63,
	0x61, 0x63, 0x68, 0x65, 0x44, 0x69, 0x72, 0x12, 0x33, 0x0a, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f,
	...
	0x6c, 0x6f, 0x67, 0x5f, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x6c, 0x6f, 0x67, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0x50, 0x0a, 0x0a, 0x4d, 0x69, 0x64,
	...
	,
...
var file_config_v1_config_proto_goTypes = []interface{}{
	(Exporter)(0),               // 0: next.config.v1.Exporter
	(*Next)(nil),                // 1: next.config.v1.Next
	(*Server)(nil),              // 2: next.config.v1.Server
	(*GRPCServer)(nil),          // 3: next.config.v1.GRPCServer
	(*HTTPServer)(nil),          // 4: next.config.v1.HTTPServer
	(*HTTPClient)(nil),          // 5: next.config.v1.HTTPClient
	(*GRPCClient)(nil),          // 6: next.config.v1.GRPCClient
	(*Logger)(nil),              // 7: next.config.v1.Logger
	(*Broker)(nil),              // 8: next.config.v1.Broker
	(*Publish)(nil),             // 9: next.config.v1.Publish
	(*Subscribe)(nil),           // 10: next.config.v1.Subscribe
	(*Registry)(nil),            // 11: next.config.v1.Registry
	(*Telemetry)(nil),           // 12: next.config.v1.Telemetry
	(*Nacos)(nil),               // 13: next.config.v1.Nacos
	(*Middleware)(nil),          // 14: next.config.v1.Middleware
	nil,                         // 15: next.config.v1.Next.MetadataEntry
	nil,                         // 16: next.config.v1.Logger.MetadataEntry
	nil,                         // 17: next.config.v1.Telemetry.OTLPHeadersEntry
	(*durationpb.Duration)(nil), // 18: google.protobuf.Duration
	(*anypb.Any)(nil),           // 19: google.protobuf.Any
}
var file_config_v1_config_proto_depIdxs = []int32{
	15, // 0: next.config.v1.Next.metadata:type_name -> next.config.v1.Next.MetadataEntry
	11, // 1: next.config.v1.Next.registry:type_name -> next.config.v1.Registry
	2,  // 2: next.config.v1.Next.server:type_name -> next.config.v1.Server
	7,  // 3: next.config.v1.Next.logger:type_name -> next.config.v1.Logger
	12, // 4: next.config.v1.Next.telemetry:type_name -> next.config.v1.Telemetry
	13, // 5: next.config.v1.Next.nacos:type_name -> next.config.v1.Nacos
	8,  // 6: next.config.v1.Next.broker:type_name -> next.config.v1.Broker
	4,  // 7: next.config.v1.Server.http:type_name -> next.config.v1.HTTPServer
	3,  // 8: next.config.v1.Server.grpc:type_name -> next.config.v1.GRPCServer
	18, // 9: next.config.v1.GRPCServer.timeout:type_name -> google.protobuf.Duration
	14, // 10: next.config.v1.GRPCServer.middlewares:type_name -> next.config.v1.Middleware
	18, // 11: next.config.v1.HTTPServer.timeout:type_name -> google.protobuf.Duration
	14, // 12: next.config.v1.HTTPServer.middlewares:type_name -> next.config.v1.Middleware
	18, // 13: next.config.v1.HTTPClient.timeout:type_name -> google.protobuf.Duration
	14, // 14: next.config.v1.HTTPClient.middlewares:type_name -> next.config.v1.Middleware
	18, // 15: next.config.v1.GRPCClient.timeout:type_name -> google.protobuf.Duration
	14, // 16: next.config.v1.GRPCClient.middlewares:type_name -> next.config.v1.Middleware
	16, // 17: next.config.v1.Logger.metadata:type_name -> next.config.v1.Logger.MetadataEntry
	9,  // 18: next.config.v1.Broker.publish:type_name -> next.config.v1.Publish
	10, // 19: next.config.v1.Broker.subscribe:type_name -> next.config.v1.Subscribe
	18, // 20: next.config.v1.Registry.timeout:type_name -> google.protobuf.Duration
	0,  // 21: next.config.v1.Telemetry.exporter:type_name -> next.config.v1.Exporter
	17, // 22: next.config.v1.Telemetry.OTLPHeaders:type_name -> next.config.v1.Telemetry.OTLPHeadersEntry
	18, // 23: next.config.v1.Nacos.timeout:type_name -> google.protobuf.Duration
	19, // 24: next.config.v1.Middleware.options:type_name -> google.protobuf.Any
