module github.com/nextmicro/next
...
require (
	...
	github.com/nextmicro/gokit/trace v1.0.2
...
require (
	...
	github.com/go-kratos/kratos/contrib/metrics/prometheus/v2 v2.0.0-20231023125239-6cdd81811e10
